...
(function(factory) {
	...
	Fancytree.prototype = /** @lends Fancytree# */ {
		...
		*/
		...
		/** Temporarily suppress renderingEnergyLocations to improve performance on bulk-updates.
		 *
		 * @param {boolean} flag
			...
			if (isStatusNode) {
				if (opts.renderStatusColumns) {
					...
					$(node.tr)
						...
						.nextAll()
						.remove();
				} // else: default renderingEnergyLocations for status node: leave other cells empty
