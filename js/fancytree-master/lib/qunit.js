...
(function (global$1) {
	...
	*/
	...
	Test.prototype = {
		...
		queueHook: function queueHook(hook, hookName, hookOwner) {
			...
			var runHook = function runHook() {
				...
				// The 'after' hook should only executed when there are not tests left and
	...
	(function () {
		...
		// Add URL-parameter-mapped config values with UI form renderingEnergyLocations data
